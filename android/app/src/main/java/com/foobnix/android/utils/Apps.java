...
public class Apps {
    ...
    /**
     * Compilation time of this APK ("yyyyMMddHHmm"), generated by the build
     * into com.foobnix.pdf.info.BuildTime (see the generateBuildTimeSource
     * task in app/build.gradle).
     */
    public static String getBuildTime(Context context) {
        return com.foobnix.pdf.info.BuildTime.BUILD_TIME;
    }
