...
public class DragingDialogs {
    ...
    public static void dialogCustomCrop(final FrameLayout anchor,
    ...
    public static void dialogContrastAndBrigtness(final FrameLayout anchor,
                                                  final DocumentController controller,
                                                  final Runnable onRealod,
    ...
    public static void dialogOnMove(final FrameLayout anchor,
                                    final DocumentController controller,
        ...
        DragingPopup dialog = new DragingPopup(controller.getString(R.string.page_position), anchor, 280, 250) {
            @Override @SuppressLint("NewApi") public View getContentView(LayoutInflater inflater) {
                ...
                if (AppSP.get().isCrop) {
                    ...
                    TintUtil.setTintImageWithAlpha(onCrop,
                                                   AppState.get().isDayNotInvert ? TintUtil.color : Color.WHITE);
                }
    ...
    public static void dialogTextToSpeech(final FrameLayout anchor,
                                          final DocumentController controller,
        ...
        DragingPopup dialog = new DragingPopup(R.string.text_to_speech, anchor, 300, 480) {
            @Override @SuppressLint("NewApi") public View getContentView(LayoutInflater inflater) {
                ...
                if (Build.VERSION.SDK_INT >= 28) {
                    ActivityManager activityManager = (ActivityManager) controller.getActivity().getSystemService(
                                    ...
                                    Intent intent =
                                            new Intent(android.provider.Settings.ACTION_APPLICATION_DETAILS_SETTINGS,
                                                       Uri.fromParts("package",
                                                                     Apps.getPackageName(controller.getActivity()),
                                                                     null));
                        ...
                        for (final int i : items) {
                            popupMenu.getMenu().add("" + i).setOnMenuItemClickListener(new OnMenuItemClickListener() {
                                @Override public boolean onMenuItemClick(MenuItem item) {
                                    ...
                                    timerTime.setText(AppState.get().ttsTimer + " " +
                                                      controller.getString(R.string.minutes).toLowerCase(Locale.US));
                ...
                timerStart.setOnClickListener(new OnClickListener() {
                    @Override public void onClick(View v) {
                        if (TempHolder.get().timerFinishTime == 0) {
                            TempHolder.get().timerFinishTime =
                                    System.currentTimeMillis() + (long) AppState.get().ttsTimer * 60 * 1000;
                        } else {
                            TempHolder.get().timerFinishTime = 0;
                        }

                        timerStart.setText(TempHolder.get().timerFinishTime == 0 ? R.string.start : R.string.cancel);
                        ttsPage.setText(TempHolder.get().timerFinishTime == 0 ?
                                        "" :
                                        controller.getString(R.string.reading_will_be_stopped) + " " +
                                        DateFormat.getTimeFormat(activity).format(TempHolder.get().timerFinishTime));
                ...
                ttsPage.setText(TempHolder.get().timerFinishTime == 0 ?
                                "" :
                                controller.getString(R.string.reading_will_be_stopped) + " " + DateFormat.getTimeFormat(
                                        activity).format(TempHolder.get().timerFinishTime));
                timerStart.setText(TempHolder.get().timerFinishTime == 0 ? R.string.start : R.string.cancel);
                ttsPage.setVisibility(TxtUtils.visibleIf(TempHolder.get().timerFinishTime > 0));
                                ...
                                AlertDialogs.showOkDialog(controller.getActivity(),
                                                          ...
                                                          new Runnable() {
                                                              @Override public void run() {
                                                                  ...
                                                                  textEngine.setText(TTSEngine.get()
                                                                                              .getCurrentEngineName());
                                                                  ttsLang.setText(TTSEngine.get().getCurrentLang());
                                                                  // TxtUtils.underlineTextView(textEngine);

                                                                  AppState.get().ttsSentecesDivs =
                                                                          AppState.TTS_PUNCUATIONS;
                ...
                ttsPlayMusicFile.setOnClickListener(new OnClickListener() {
                    @Override public void onClick(View v) {
                        ...
                        ChooserDialogFragment.chooseFileorFolder((FragmentActivity) controller.getActivity(),
                                                                 controller.getString(R.string.open_file))
                ...
                ttsSkeakToFile.setOnClickListener(new OnClickListener() {
                    @Override public void onClick(View v) {
                        ...
                        View inflate = LayoutInflater.from(v.getContext()).inflate(R.layout.dialog_tts_wav,
                                                                                   null,
                                                                                   false);
                        ...
                        isConvertToMp3.setOnCheckedChangeListener((buttonView, isChecked) ->
                                                                          AppState.get().isConvertToMp3 = isChecked);
                        ...
                        ttsSpeakPath.setOnClickListener(new OnClickListener() {
                            @Override public void onClick(View v) {
                                ...
                                ChooserDialogFragment.chooseFolder((FragmentActivity) controller.getActivity(),
                        ...
                        delete.setOnClickListener(v1 -> {
                            if (TempHolder.isRecordTTS) {
                                Toast.makeText(controller.getActivity(), R.string.please_wait, Toast.LENGTH_SHORT)
                                     .show();
                                return;
                            }
                        ...
                        final ResultResponse<String> info = new ResultResponse<String>() {
                            @Override public boolean onResultRecive(final String result) {
                            ...
                            @Override public void onClick(View v) {
                                ...
                                if (!hasErorrs && !TempHolder.isRecordTTS) {
                                    ...
                                    TTSEngine.get().speakToFile(controller,
                                                                info,
                                                                TempHolder.isRecordFrom,
                                                                TempHolder.isRecordTo);
                                }
                            }
                        });
    ...
    @SuppressLint("NewApi")
    public static void dialogFooterNotes(final FrameLayout anchor,
                                         final DocumentController controller,
                                         final Runnable updateLinks) {
    ...
    public static void dialogSelectText(final FrameLayout anchor,
                                        final DocumentController controller,
                                        boolean withAnnotation1,
                                        final Runnable reloadUI) {
            ...
            @Override public View getContentView(LayoutInflater inflater) {
                ...
                final Runnable updateConfigRunnable = new Runnable() {
                    @Override public void run() {
                        ...
                        for (final String line : AppState.get().customConfigColors.split(",")) {
                            ...
                            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(Dips.dpToPx(35),
                                                                                             Dips.dpToPx(35));
                ...
                onAddCustom.setOnClickListener(new OnClickListener() {
                    @Override public void onClick(View v) {
                        ...
                        menu.getMenu()
                            .add(R.string.highlight_of_text)
                            .setIcon(highlight)
                            .setOnMenuItemClickListener(new OnMenuItemClickListener() {
                                @Override public boolean onMenuItemClick(MenuItem item) {
                        ...
                        menu.getMenu()
                            .add(R.string.underline_of_text)
                            .setIcon(underline)
                            .setOnMenuItemClickListener(new OnMenuItemClickListener() {
                                @Override public boolean onMenuItemClick(MenuItem item) {
                        ...
                        menu.getMenu()
                            .add(R.string.strikethrough_of_text)
                            .setIcon(strikeout)
                            .setOnMenuItemClickListener(new OnMenuItemClickListener() {
                                @Override public boolean onMenuItemClick(MenuItem item) {
                ...
                for (final String colorName : colors) {
                    final View inflate =
                            LayoutInflater.from(linearLayoutColor.getContext()).inflate(R.layout.item_color,
                                                                                        linearLayoutColor,
                                                                                        false);
                ...
                view.findViewById(R.id.onTranslate).setOnClickListener(v -> {
                    ...
                    final Map<String, String> providers = AppData.get().getWebDictionaries(editText.getText()
                                                                                                   .toString()
                                                                                                   .trim());
                ...
                view.findViewById(R.id.onGoogle).setOnClickListener(v -> {
                    anchor.removeAllViews();
                    final PopupMenu popupMenu = new PopupMenu(v.getContext(), view);
                    final Map<String, String> providers = AppData.get().getWebSearch(editText.getText()
                                                                                             .toString()
                                                                                             .trim());
                    for (final String name : providers.keySet()) {
                        popupMenu.getMenu().add(name).setOnMenuItemClickListener(item -> {
                ...
                view.findViewById(R.id.onAddToBookmark).setOnClickListener(new OnClickListener() {
                    @Override public void onClick(View v) {
                        controller.clearSelectedText();
                        closeDialog();
                        ListBoxHelper.showAddDialog(controller,
                                                    null,
                                                    null,
                                                    null,
                ...
                onShare.setOnClickListener(new
                                                   ...
                                                   OnClickListener() {
                                                       @Override public void onClick(View v) {
                                                           ...
                                                           List<String> list = Arrays.asList("Format: Quote",
                                                                                             "Format: \"Quote\"\n-- Author",
                                                                                             "Format: \"Quote\"\n-- Author\nTitle");

                                                           MyPopupMenu menu = new MyPopupMenu(v);
                                                           for (String line : list) {
                                                               menu.getMenu().add(line).setOnMenuItemClickListener(
                                                                       menuItem -> {
                                                                           String res = line.replace("Format: ", "");
                                                                           res = res.replace("Author",
                                                                                             meta.getAuthor());
                                                                           ...
                                                                           controller.getActivity()
                                                                                     .startActivity(Intent.createChooser(
                                                                                             intent,
                                                                                             controller.getString(R.string.share)));
                                                                           controller.clearSelectedText();
                                                                           closeDialog();
                                                                           return false;
                                                                       });
                ...
                if (onBookSearch != null) {
                    ...
                    onBookSearch.setVisibility(
                            selectedText != null && selectedText.contains(" ") ? View.GONE : View.VISIBLE);
                ...
                for (final ResolveInfo app : keep) {
                    for (final String pkgKey : AppState.appDictionariesKeys) {
                        ...
                        if (pkg.toLowerCase(Locale.US).contains(pkgKey) ||
                            DictsHelper.getHash(app.activityInfo) == AppState.get().rememberDictHash2) {
                            ...
                            try {
                                ...
                                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(Dips.dpToPx(44),
                                                                                                       Dips.dpToPx(44));
                                layoutParams.rightMargin = Dips.dpToPx(8);
                                image.setLayoutParams(layoutParams);
                                Drawable icon = anchor.getContext()
                                                      .getPackageManager()
                                                      .getApplicationIcon(app.activityInfo.packageName);
                                ...
                                image.setOnClickListener(new OnClickListener() {
                                    @Override public void onClick(View v) {
                                        ...
                                        if (customList.contains(app)) {
                                            ...
                                            intentCustom.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK |
                                            ...
                                            intentProccessText.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK |
                                                                        Intent.FLAG_ACTIVITY_RESET_TASK_IF_NEEDED);
                                            ...
                                            intentProccessText.putExtra(Intent.EXTRA_PROCESS_TEXT_READONLY,
                                                                        selecteText);
                ...
                image.setOnClickListener(new
                                                 ...
                                                 OnClickListener() {
                                                     @Override public void onClick(View v) {
                                                         DialogTranslateFromTo.show(controller.getActivity(),
                                                                                    true,
                                                                                    new Runnable() {
                                                                                        @Override public void run() {
                                                                                            sp.edit()
                                                                                              .putString("last",
                                                                                                         "" +
                                                                                                         AppState.get().rememberDictHash2)
                                                                                              .commit();
                                                                                            dialogSelectText(anchor,
                                                                                                             controller,
                                                                                                             withAnnotation,
                                                                                                             reloadUI);
                                                                                        }
                ...
                view.findViewById(R.id.onUnderline).
                        ...
                        setOnClickListener(new OnClickListener() {
                    @Override public void onClick(View v) {
                        controller.underlineText(Color.parseColor(AppState.get().annotationTextColor),
                                                 2.0f,
    ...
    public static void dialogGoToPage(final FrameLayout anchor, final DocumentController dc) {
        ...
        DragingPopup popup = new DragingPopup(R.string.go_to_page_dialog, anchor, 300, 400) {
            ...
            @Override public void beforeCreate() {
                ...
                titlePopupMenu.getMenu().addCheckbox(dc.getString(R.string.show_search_bar),
                                                     AppState.get().isShowSearchBar,
                                                     (buttonView, isChecked) -> {
                                                         AppState.get().isShowSearchBar = isChecked;
                                                         searchLayout.setVisibility(isChecked ?
                                                                                    View.VISIBLE :
                                                                                    View.GONE);
                                                         beforeCreate();
                                                     });

                titlePopupMenu.getMenu().addCheckbox(dc.getString(R.string.show_fast_scroll),
                                                     AppState.get().isShowFastScroll,
                                                     (buttonView, isChecked) -> {
            ...
            @Override public View getContentView(LayoutInflater inflater) {
                ...
                if (ExtUtils.isValidFile(currentBook)) {
                    grid.setAdapter(new PageThumbnailAdapter(anchor.getContext(),
                                                             dc.getPageCount(),
                ...
                grid.setOnItemLongClickListener(new OnItemLongClickListener() {
                    @Override public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        menu.getMenu()
                            .add(R.string.share_as_text)
                            .setIcon(R.drawable.glyphicons_578_share)
                            .setOnMenuItemClickListener((it) -> {
                                final Intent intent = new Intent(Intent.ACTION_SEND);
                                intent.setType("text/plain");
                                intent.putExtra(Intent.EXTRA_TEXT, dc.getTextForPage(position));
                                dc.getActivity().startActivity(Intent.createChooser(intent,
                                                                                    dc.getActivity()
                                                                                      .getString(R.string.share)));
                                return true;
                            });
                        menu.getMenu()
                            .add(R.string.share_as_image)
                            .setIcon(R.drawable.glyphicons_38_picture)
                            .setOnMenuItemClickListener((it) -> {
                        ...
                        menu.getMenu()
                            ...
                            .setIcon(R.drawable.glyphicons_614_copy)
                            .setOnMenuItemClickListener((it) -> {
                                ClipboardManager clipboard = (ClipboardManager) dc.getActivity().getSystemService(
                                        Context.CLIPBOARD_SERVICE);
                                ClipData clip = ClipData.newPlainText(dc.getString(R.string.copy_text),
                                                                      dc.getTextForPage(position));
                                clipboard.setPrimaryClip(clip);
                    ...
                    @Override public void onClick(View v) {
                        ...
                        try {
                            ...
                            if (txt.contains("%") || txt.contains(".") || txt.contains(",")) {
                                ...
                                if (parseFloat > 100) {
                                    Toast.makeText(dc.getActivity(), R.string.incorrect_value, Toast.LENGTH_SHORT)
                                         .show();
                                }
    ...
    public static void dialogEditColors(final FrameLayout anchor,
                                        final DocumentController controller,
        ...
        new DragingPopup(R.string.annotations_draw, anchor, 250, 150) {
            ...
            @Override public View getContentView(final LayoutInflater inflater) {
                ...
                final BaseItemAdapter<String> adapter = new BaseItemAdapter<String>(AppState.COLORS) {
                    @Override public View getView(int pos, View arg1, ViewGroup arg2, String color) {
                        View view = null;
                        if (pos == 0) {
                            ...
                            final List<Float> values = Arrays.asList(0.5f,
                                                                     0.75f,
                                                                     1f,
                                                                     2f,
                                                                     3f,
                                                                     ...
                                                                     9f,
                                                                     10f);
                            spinner.setAdapter(new BaseItemLayoutAdapter<Float>(anchor.getContext(),
                                                                                android.R.layout.simple_spinner_dropdown_item,
                                                                                values) {
                                @Override public void populateView(View inflate, int arg1, Float value) {
                            ...
                            spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
                                ...
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    int acolor = IMG.alphaColor(AppState.get().editAlphaColor,
                                                                AppState.get().annotationDrawColor);
                            ...
                            spinner.setAdapter(new BaseItemLayoutAdapter<Integer>(anchor.getContext(),
                                                                                  android.R.layout.simple_spinner_dropdown_item,
                                                                                  values) {
                                @Override public void populateView(View inflate, int arg1, Integer value) {
                                    TextView text = Views.text(inflate, android.R.id.text1, "" + value + "%");
                                }
                            });
                            spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
    ...
    public static void dialogShowBookmarks(final FrameLayout anchor,
        ...
        final View.OnClickListener onAddBookmark = new View.OnClickListener() {
            @Override public void onClick(final View v) {
                ListBoxHelper.showAddDialog(controller, objects, allData, bookmarksAdapter, "", onRefeshUI);
            }
        };
        ...
        new DragingPopup(R.string.bookmarks, anchor, 300, 400) {
            @Override public View getContentView(final LayoutInflater inflater) {
                ...
                EditText searchBookmark = a.findViewById(R.id.searchBookmark);
                ImageView cleanBookmarkSearch = a.findViewById(R.id.cleanBookmarkSearch);
                ...
                titlePopupMenu.getMenu(R.drawable.glyphicons_578_share,
                                       R.string.share,
                                       () -> ExtUtils.sendBookmarksTo(controller.getActivity(),
    ...
    public static void dialogShowContent(final FrameLayout anchor, final DocumentController controller) {
        ...
        final ItemClickListenerWithReference<DragingPopup> onClickContent =
                new ItemClickListenerWithReference<DragingPopup>() {
                    int prev = -1;
            ...
            @Override public View getContentView(LayoutInflater inflater) {
                                ...
                                new ProgressTask<File>() {
                                    ...
                                    @Override protected void onPreExecute() {
                                        dialog = MyProgressDialog.show(controller.getActivity(),
                                                                       controller.getString(R.string.msg_loading));
                                    }
                ...
                if (false) {
                    setTitlePopupIcon(AppState.get().outlineMode == AppState.OUTLINE_ONLY_HEADERS ?
                                      R.drawable.my_glyphicons_114_paragraph_justify :
                                      R.drawable.my_glyphicons_114_justify_sub);
                    titlePopupMenu = new MyPopupMenu(controller.getActivity(), null);
                    ...
                    final List<Integer> icons = Arrays.asList(R.drawable.my_glyphicons_114_paragraph_justify,
                                                              R.drawable.my_glyphicons_114_justify_sub);
                    final List<Integer> actions = Arrays.asList(AppState.OUTLINE_ONLY_HEADERS,
                                                                AppState.OUTLINE_HEADERS_AND_SUBHEADERES);
    ...
    public static void dialogSlice(final FrameLayout anchor,
                                   final DocumentController controller,
                                   final Runnable onRefreshDoc,
                                   final ResultResponse<Integer> onMoveCut) {
    ...
    public static void dialogPageFlipping(final FrameLayout anchor,
                                          final DocumentController controller,
                                          final Runnable onRefresh) {
        if (controller == null) {
            return;
        ...
        new DragingPopup(anchor.getContext().getString(R.string.automatic_page_flipping), anchor, 300, 380) {
            @Override public View getContentView(LayoutInflater inflater) {
                ...
                isScrollAnimation.setVisibility(
    ...
    public static void dialogStatusBarSettings(final FrameLayout anchor,
                                               final DocumentController controller,
                                               final Runnable onRefresh,
                                               final Runnable updateUIRefresh) {
        ...
        DragingPopup dialog = new DragingPopup(R.string.status_bar, anchor, PREF_WIDTH, PREF_HEIGHT) {
            ...
            @Override public View getContentView(final LayoutInflater inflater) {
                ...
                ((View) musicText.getParent()).setVisibility(
                        AppSP.get().readingMode == AppState.READING_MODE_MUSICIAN ? View.VISIBLE : View.GONE);
                ...
                isShowRectangularTapZones.setVisibility(
                        AppSP.get().readingMode == AppState.READING_MODE_MUSICIAN ? View.VISIBLE : View.GONE);
                ...
                isShowLineDividing.setVisibility(
                        AppSP.get().readingMode == AppState.READING_MODE_MUSICIAN ? View.VISIBLE : View.GONE);
                ...
                isShowLastPageRed.setVisibility(
                        AppSP.get().readingMode == AppState.READING_MODE_MUSICIAN ? View.VISIBLE : View.GONE);
                ...
                isShowPanelBookName.setChecked(controller.isBookMode() ?
                                               AppState.get().isShowPanelBookNameBookMode :
                                               AppState.get().isShowPanelBookNameScrollMode);
                ...
                chapterFormat.setOnClickListener(new OnClickListener() {
                    @Override public void onClick(View v) {
                        ...
                        for (int i = 0; i < OutlineHelper.CHAPTER_STRINGS.size(); i++) {
                            final int j = i;
                            popupMenu.getMenu()
                                     .add(OutlineHelper.CHAPTER_STRINGS.get(i))
                                     .setOnMenuItemClickListener(new OnMenuItemClickListener() {
                                         @Override public boolean onMenuItemClick(MenuItem item) {
                                             AppState.get().chapterFormat = OutlineHelper.CHAPTER_FORMATS.get(j);
                                             chapterFormat.setText(OutlineHelper.CHAPTER_STRINGS.get(OutlineHelper.CHAPTER_FORMATS.indexOf(
                                                     AppState.get().chapterFormat)));
                                             TxtUtils.underlineTextView(chapterFormat);
                                             if (onRefresh != null) {
                                                 onRefresh.run();
                                             }
                ...
                statusBarTextSize.init(5,
                                       30,
                                       controller.isBookMode() ?
                                       AppState.get().statusBarTextSizeEasy :
                                       AppState.get().statusBarTextSizeAdv);
                ...
                statusBarColorNight.setOnLongClickListener(new OnLongClickListener() {
                    @Override public boolean onLongClick(View v) {
                        Dialogs.showEditDialog(v.getContext(),
                                               false,
                                               statusBarColorNight.getTextString(),
    ...
    public static void dialogPerformanceSettings(final FrameLayout anchor,
                                                 final DocumentController controller,
                                                 final Runnable onRefresh,
                                                 final Runnable updateUIRefresh) {
        ...
        DragingPopup dialog = new DragingPopup(R.string.advanced_settings, anchor, PREF_WIDTH, PREF_HEIGHT) {
                ...
                titleRunnable = new Runnable() {
                    @Override public void run() {
                        if (initHash != Objects.appHash()) {
                            AlertDialogs.showDialog(controller.getActivity(),
                                                    controller.getString(R.string.you_neet_to_apply_the_new_settings),
                                                    controller.getString(R.string.apply),
                                                    new Runnable() {
                                                        @Override public void run() {
                                                            closeDialog();
                                                        }
            ...
            @Override public View getContentView(final LayoutInflater inflater) {
                ...
                isSelectTexByTouch.setOnCheckedChangeListener((buttonView, isChecked) ->
                                                                      AppState.get().isSelectTexByTouch = isChecked);
                ...
                isZoomInOutWithVolueKeys.setOnCheckedChangeListener((buttonView, isChecked) ->
                                                                            AppState.get().isZoomInOutWithVolueKeys =
                                                                                    isChecked);
                ...
                isZoomInOutWithLock.setOnCheckedChangeListener((buttonView, isChecked) ->
                ...
                isSwipeGestureReverse.setVisibility(
                        AppSP.get().readingMode == AppState.READING_MODE_BOOK ? View.VISIBLE : View.GONE);
                isSwipeGestureReverse.setImageResource(AppState.get().isSwipeGestureReverse ?
                                                       R.drawable.glyphicons_212_arrow_up :
                                                       R.drawable.glyphicons_211_arrow_down);
                ...
                isEnableHorizontalSwipe.setVisibility(
                        AppSP.get().readingMode == AppState.READING_MODE_BOOK ? View.VISIBLE : View.GONE);
                ...
                isReferenceMode.setVisibility(TxtUtils.visibleIf(BookType.EPUB.is(controller.getCurrentBook()
                                                                                            .getPath())));
                ...
                isShowPageNumbers.setVisibility(TxtUtils.visibleIf(BookType.EPUB.is(controller.getCurrentBook()
                                                                                              .getPath())));
                ...
                isBionicMode.setOnCheckedChangeListener((buttonView, isChecked) -> AppState.get().isBionicMode =
                        isChecked);
                ...
                isIgnoreAnnotatations.setVisibility(!(AppSP.get().readingMode == AppState.READING_MODE_BOOK) &&
                                                    BookType.PDF.is(controller.getCurrentBook().getPath()) ?
                                                    View.VISIBLE :
                                                    View.GONE);
                ...
                isSaveAnnotatationsAutomatically.setVisibility(
                        !(AppSP.get().readingMode == AppState.READING_MODE_BOOK) &&
                        BookType.PDF.is(controller.getCurrentBook().getPath()) ? View.VISIBLE : View.GONE);
                ...
                ((ViewGroup) pageQuality.getParent()).setVisibility(
                        AppSP.get().readingMode == AppState.READING_MODE_BOOK &&
                        !ExtUtils.isTextFomat(controller.getCurrentBook().getPath()) ? View.VISIBLE : View.GONE);
                ...
                ((ViewGroup) pagesInMemory.getParent()).setVisibility(
                        AppSP.get().readingMode == AppState.READING_MODE_BOOK ? View.VISIBLE : View.GONE);
                ...
                inactivityTime.setText(AppState.get().inactivityTime == -1 ?
                                       controller.getString(R.string.system) :
                                       "" + AppState.get().inactivityTime);
                TxtUtils.underlineTextView(inactivityTime);
                inactivityTime.setOnClickListener(new OnClickListener() {
                    @Override public void onClick(View v) {
                        final PopupMenu popupMenu = new PopupMenu(v.getContext(), v);

                        popupMenu.getMenu().add("" + controller.getString(R.string.system)).setOnMenuItemClickListener(
                ...
                ((ViewGroup) rotate.getParent()).setVisibility(
                        AppSP.get().readingMode == AppState.READING_MODE_BOOK ? View.VISIBLE : View.GONE);
                            ...
                            popupMenu.getMenu()
                                     ...
                                     .setOnMenuItemClickListener(new OnMenuItemClickListener() {
                                         @Override public boolean onMenuItemClick(MenuItem item) {
                                             ...
                                             allocatedMemorySize.setText(
                                                     "" + AppState.get().allocatedMemorySize + "Mb");
                                             TxtUtils.underlineTextView(allocatedMemorySize);
                                             return false;
                                         }
                                     });
                            ...
                            popupMenu.getMenu()
                                     ...
                                     .setOnMenuItemClickListener(new OnMenuItemClickListener() {
                                         @Override public boolean onMenuItemClick(MenuItem item) {
                                             ...
                                             remindRestTime.setText(
                                                     AppState.get().remindRestTime + " " + minutesString);
                                             TxtUtils.underlineTextView(remindRestTime);
                                             return false;
                                         }
                                     });
                ...
                ((ViewGroup) rotateViewPager.getParent()).setVisibility(
                        AppSP.get().readingMode == AppState.READING_MODE_BOOK ? View.VISIBLE : View.GONE);
                ...
                rotateViewPager.setOnClickListener(new OnClickListener() {
                    @SuppressLint("NewApi") @Override public void onClick(View v) {
                        final PopupMenu popupMenu = new PopupMenu(v.getContext(), v);
                        popupMenu.getMenu()
                                 .add(R.string.horizontal)
                                 .setOnMenuItemClickListener(new OnMenuItemClickListener() {
                                     @Override public boolean onMenuItemClick(MenuItem item) {
                                         AppState.get().rotateViewPager = 0;
                                         rotateViewPager.setText(AppState.get().rotateViewPager == 0 ?
                                                                 R.string.horizontal :
                                                                 R.string.vertical);
                                         TxtUtils.underlineTextView(rotateViewPager);
                                         return false;
                ...
                rtlText.setOnClickListener(new OnClickListener() {
                    @Override public void onClick(View v) {
                        final PopupMenu popupMenu = new PopupMenu(v.getContext(), v);
                        popupMenu.getMenu()
                                 .add(R.string.left_to_rigth)
                                 .setOnMenuItemClickListener(new OnMenuItemClickListener() {
                                     @Override public boolean onMenuItemClick(MenuItem item) {
                                         AppState.get().isRTLByDefault = false;
                        ...
                        popupMenu.getMenu()
                                 .add(R.string.right_to_left)
                                 .setOnMenuItemClickListener(new OnMenuItemClickListener() {
                                     @Override public boolean onMenuItemClick(MenuItem item) {
                                         AppState.get().isRTLByDefault = true;
                ...
                decodingThreadPriority.init(Thread.MIN_PRIORITY,
                                            Thread.MAX_PRIORITY,
                                            CoreSettings.get().decodingThreadPriority);
                ...
                drawThreadPriority.init(Thread.MIN_PRIORITY,
                                        Thread.MAX_PRIORITY,
                                        CoreSettings.get().drawThreadPriority);
    ...
    public static void dialogMoreBookSettings(final FrameLayout anchor,
                                              final DocumentController controller,
                                              final Runnable onRefresh,
                                              final Runnable updateUIRefresh) {
        final int initHash = Objects.appHash();
...
// begin styles
                ...
                inflate.findViewById(R.id.documentStyleLayout)
                       .setVisibility(ExtUtils.isTextFomat(controller.getCurrentBook().getPath()) ?
                                      View.VISIBLE :
                                      View.GONE);
                ...
                //user styles
                inflate.findViewById(R.id.userStyles).setVisibility(ExtUtils.isTextFomat(controller.getCurrentBook()
                                                                                                   .getPath()) ?
                                                                    View.VISIBLE :
                                                                    View.GONE);
                        ...
                        ChooserDialogFragment.chooseFolder((FragmentActivity) controller.getActivity(),
                                             ...
                                             .setOnSelectListener(new ResultResponse2<String, Dialog>() {
                                                 @Override public boolean onResultRecive(String nPath, Dialog dialog) {
                                                     ...
                                                     TxtUtils.underline(fontsFolder,
                                                                        TxtUtils.lastTwoPath(BookCSS.get().fontFolder));
                                                     AppProfile.save(controller.getActivity());
                                                     dialog.dismiss();
                                                     return false;
                                                 }
...
// link color
                ...
                TxtUtils.underlineTextView(inflate.findViewById(R.id.onResetStyles))
                        .setOnClickListener(new OnClickListener() {
                            @Override public void onClick(View v) {
                                ...
                                AlertDialogs.showOkDialog(controller.getActivity(),
                                                          ...
                                                          new Runnable() {
                                                              @Override public void run() {
                                                                  BookCSS.get()
                                                                         .resetToDefault(controller.getActivity());

                                                                  fontsFolder.setText(TxtUtils.underline(TxtUtils.lastTwoPath(
                                                                          BookCSS.get().fontFolder)));
                                                                  textAlign.setText(TxtUtils.underline(alignConst.get(
                                                                          BookCSS.get().textAlign)));

                                                                  fontWeight.reset(BookCSS.get().fontWeight / 100);
                                                                  fontWeight.setValueText(
                                                                  ...
                                                                  linkColorDay.init(Color.parseColor(BookCSS.get().linkColorDay));
                                                                  linkColorNight.init(Color.parseColor(BookCSS.get().linkColorNight));
                                                                  linkColorDay.withDefaultColors(StringDB.converToColor(
                                                                          BookCSS.get().linkColorDays));
    ...
    public static void dialogPreferences(final FrameLayout anchor,
                                         final DocumentController controller,
                                         final Runnable onRefresh,
                                         final Runnable updateUIRefresh) {
        final int initHash = Objects.appHash();
        ...
        DragingPopup dialog = new DragingPopup(R.string.preferences, anchor, PREF_WIDTH, PREF_HEIGHT) {
            @Override public View getContentView(final LayoutInflater inflater) {
                ...
                brightness.setImageResource(!AppState.get().isDayNotInvert ?
                                            R.drawable.glyphicons_232_sun :
                                            R.drawable.glyphicons_231_moon);
                ...
                isCrop.setOnClickListener(new View.OnClickListener() {
                    @Override public void onClick(final View v) {
                        AppSP.get().isCrop = !AppSP.get().isCrop;
                        SettingsManager.getBookSettings().updateFromAppState();
                        TintUtil.setTintImageWithAlpha(isCrop,
                                                       !AppSP.get().isCrop ? TintUtil.COLOR_TINT_GRAY : Color.LTGRAY);
                        updateUIRefresh.run();
                    }
                });
                ...
                bookCut.setOnClickListener(new View.OnClickListener() {
                    @Override public void onClick(final View v) {
                        ...
                        DragingDialogs.dialogSlice(anchor, controller, updateUIRefresh, new ResultResponse<Integer>() {
                            @Override public boolean onResultRecive(Integer result) {
                                TintUtil.setTintImageWithAlpha(bookCut,
                                                               !AppSP.get().isCut ?
                                                               TintUtil.COLOR_TINT_GRAY :
                                                               Color.LTGRAY);
                                SettingsManager.getBookSettings().updateFromAppState();
                                EventBus.getDefault().post(new InvalidateMessage());
                                return false;
                ...
                pin.setOnClickListener(new View.OnClickListener() {
                    @Override public void onClick(final View v) {
                        ...
                        pin.setImageResource(AppState.get().isShowToolBar ?
                                             R.drawable.glyphicons_415_push_pin :
                                             R.drawable.glyphicons_305_no_symbol);
                        if (onRefresh != null) {
                            onRefresh.run();
                        }
                    }
                ...
                boolean isTxtOrZip = BookType.TXT.is(controller.getCurrentBook().getPath()) || BookType.ZIP.is(
                        controller.getCurrentBook().getPath());
                ...
                ((View) isCharacterEncoding.getParent()).setVisibility(
                        isTxtOrZip || controller.getCurrentBook().getPath().endsWith(".pdb") ?
                        View.VISIBLE :
                        View.GONE);
                ...
                inflate.findViewById(R.id.moreSettingsDiv).setVisibility(controller.isTextFormat() ?
                                                                         View.VISIBLE :
                                                                         View.GONE);
                ...
                inflate.findViewById(R.id.fontSizeLayout).setVisibility(ExtUtils.isTextFomat(controller.getCurrentBook()
                                                                                                       .getPath()) ?
                                                                        View.VISIBLE :
                                                                        View.GONE);
                inflate.findViewById(R.id.fontNameSelectionLayout)
                       .setVisibility(ExtUtils.isTextFomat(controller.getCurrentBook().getPath()) ?
                                      View.VISIBLE :
                                      View.GONE);
                ...
                textFontName.setOnClickListener(new OnClickListener() {
                    @Override public void onClick(View v) {
                        ...
                        for (final FontPack pack : fontPacks) {
                            ...
                            popup.getMenu()
                                 .add(pack.dispalyName, pack.normalFont)
                                 .setOnMenuItemClickListener(new OnMenuItemClickListener() {
                                     @Override public boolean onMenuItemClick(MenuItem item) {
                ...
                textDayColor.setOnClickListener(new OnClickListener() {
                    @Override public void onClick(View v) {
                        ...
                        new ColorsDialog((FragmentActivity) controller.getActivity(),
                                         true,
                                         AppState.get().colorDayText,
                                         AppState.get().colorDayBg,
                                         AppState.get().colorDayForeground,
                                         false,
                                         isSolid,
                                         new ColorsDialogResult() {
                                             @Override
                                             public void onChooseColor(int colorText,
                                                                       int colorBg,
                                                                       int colorForeground) {
                                         ...
                                         new ColorsDialogResult() {
                                             ...
                                             public void onChooseColor(int colorText,
                                                 ...
                                                 if (AppState.get().isUseBGImageNight) {
                                                     textNigthColor.setBackground(MagicHelper.getBgImageNightDrawable(
                                                             true));
                                                 }
                                             }
                                         });
                ...
                final Runnable colorsLine = new Runnable() {
                    @Override public void run() {
                        ...
                        for (String line : AppState.get().readColors.split(";")) {
                            ...
                            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(Dips.dpToPx(30),
                                                                                             Dips.dpToPx(30));
                        ...
                        // add Night image
                        {
                            ...
                            LinearLayout.LayoutParams params2 = new LinearLayout.LayoutParams(Dips.dpToPx(30),
                                                                                              Dips.dpToPx(30));
                        ...
                        .setOnClickListener(new OnClickListener() {
                            @Override public void onClick(View v) {
                                ...
                                AlertDialogs.showOkDialog(controller.getActivity(),
                                                          ...
                                                          new Runnable() {
                                                              @Override public void run() {
                                                                  AppState.get().readColors =
                                                                          AppState.READ_COLORS_DEAFAUL;
                                                                  AppState.get().isUseBGImageDay = false;
                                                                  AppState.get().isUseBGImageNight = false;

                                                                  AppState.get().bgImageDayTransparency =
                                                                          AppState.DAY_TRANSPARENCY;
                                                                  AppState.get().bgImageDayPath =
                                                                          MagicHelper.IMAGE_BG_1;

                                                                  AppState.get().bgImageNightTransparency =
                                                                          AppState.NIGHT_TRANSPARENCY;
                                                                  AppState.get().bgImageNightPath =
                                                                          MagicHelper.IMAGE_BG_1;
                                                                  ...
                                                                  AppState.get().colorDayForeground =
                                                                          AppState.COLOR_DAY_FG;
                                                                  AppState.get().colorNigthForeground =
                                                                          AppState.COLOR_NIGHT_FG;

                                                                  textDayColor.setTextColor(AppState.get().colorDayText);
                                                                  textDayColor.setBackgroundColor(AppState.get().colorDayBg);

                                                                  AppState.get().colorNigthText =
                                                                          AppState.COLOR_WHITE_2;
                                                                  AppState.get().colorNigthBg = AppState.COLOR_BLACK_2;

                                                                  textNigthColor.setTextColor(AppState.get().colorNigthText);
                                                                  textNigthColor.setBackgroundColor(AppState.get().colorNigthBg);

                                                                  TintUtil.setTintImageWithAlpha(onDayColorImage,
                                                                                                 AppState.get().colorDayText);
                                                                  TintUtil.setTintImageWithAlpha(onNigthColorImage,
                                                                                                 AppState.get().colorNigthText);

                                                                  AppState.get().statusBarColorDay = Color.parseColor(
                                                                          AppState.TEXT_COLOR_DAY);
                                                                  AppState.get().statusBarColorNight = Color.parseColor(
                                                                          AppState.TEXT_COLOR_NIGHT);
                ...
                inflate.findViewById(R.id.moreReadColorSettings).setOnClickListener(new OnClickListener() {
                    @Override public void onClick(View v) {
                        ...
                        for (String line : AppState.get().readColors.split(";")) {
                            ...
                            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(Dips.dpToPx(60),
                                                                                             Dips.dpToPx(30));
                            params.setMargins(padding, padding, padding, padding);
                            ...
                            child.setOnClickListener(new OnClickListener() {
                                @Override public void onClick(View v) {
                                    new ColorsDialog((FragmentActivity) controller.getActivity(),
                                                     (Boolean) t1Img.getTag(),
                                                     (Integer) t3Text.getTag(),
                                                     (Integer) t2BG.getTag(),
                                                     MagicHelper.ligtherColor((Integer) t2BG.getTag()),
                                                     true,
                                                     true,
                                                     new ColorsDialogResult() {
                                                         @Override
                                                         public void onChooseColor(int colorText,
                                                             ...
                                                             t2BG.setText(TxtUtils.underline(MagicHelper.colorToString(
                                                                     colorBg)));
                                                             t3Text.setText(TxtUtils.underline(MagicHelper.colorToString(
                                                                     colorText)));

                                                             t2BG.setTag(colorBg);
                                                             t3Text.setTag(colorText);

                                                             String line = name + "," + MagicHelper.colorToString(
                                                                     colorBg) + "," + MagicHelper.colorToString(
                                                                     colorText) + "," + split[3];
                                                             child.setTag(line);
                                                         }
                                                     });
