...
//        analytics.setUserProperty("APP_VERSION", Apps.getVersionName(this));
        ...
        try {
            if (AppsConfig.isShowAdsInApp(this)) {
                ...
                // All SDK work lives behind the ad facade/provider compiled
                // into this variant (src/admobAds); GMS-free builds
                // (fdroid/pro, src/noAds) get a no-op here.
                ADS.get().initialize(this);
            }
        } catch (Exception e) {
            LOG.e(e);
        }
