...
# HowReadPro 好好读Pro — 高度可定制的电子书阅读器

> **HowReadPro（好好读Pro）** 是一款高度可定制、功能丰富的阅读应用，支持在 **Android / HarmonyOS（鸿蒙）** 设备上阅读 **PDF、EPUB、MOBI、DjVu、FB2、TXT、RTF、AZW、AZW3、HTML、CBZ、CBR** 等格式的图书与文档。界面直观、功能强大，还带有独特的免提自动滚动**音乐家模式**。
...
通过 **HowReadPro 好好读Pro**，你可以指定要收录的格式与要扫描的文件夹，轻松建立自维护的书库。所有文档集合可以列表或网格方式查看，通过可调大小、可调样式的缩略图封面和详细信息快速识别；书库可按路径、名称、大小、日期等排序，并配有筛选器帮助你定位特定文档。
